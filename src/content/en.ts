...
export const en: typeof th = {
  ...
  home: {
    ...
    photoCaption: "Generated illustration: a laptop on a teak café table in Bangkok showing a cream small-business landing page — an illustrative still, not a client capture",
    photoAlt: "A laptop on a teak café table in warm late-afternoon Bangkok light, the screen showing a cream Thai small-business landing page with a terracotta LINE/BOOK button — an illustrative still, not a client capture",
    demoLabel: "ตัวอย่างการทำงาน · Ops preview",
    smeLabel: "เว็บธุรกิจเล็ก · SME example",
    doorEnterprise: {
      ...
      imgAlt: "A Bangkok office desk at dusk with a monitor showing a job tracker of work orders with status chips and preview thumbnails, lit by a warm lamp — generated illustrative still",
    },
    doorSme: {
      ...
      imgAlt: "Interior of a small Thai flower shop with a wooden counter, a wall card listing services and opening hours in Thai, and a LINE QR card on the counter — generated illustrative still",
    },
    thumbs: [
      {
        src: "/img/door-internal.jpg",
        alt: "Generated illustrative still of a dusk office desk with a work-order tracker on screen (a demo, not a client)",
      },
      {
    ...
    anatomy: {
      eyebrow: "Anatomy of a landing page",
      heading: "What a page that sells is made of",
      dek: "One generated still of a complete landing page — a photo hero at the top, a testimonial band in the middle, and a clear CTA at the bottom. The numbered dots mark each zone.",
      caption: "Generated illustrative still of a landing page (a demo, not a real site) — hero, proof, and CTA in one frame",
      callouts: [
        {
          title: "1 · Photo hero",
          desc: "A clear headline with a photo at the top — visitors know who this is within seconds",
        },
        {
          title: "2 · Proof band",
          desc: "A testimonial band mid-page — short evidence that builds trust before the CTA",
        },
        {
          title: "3 · CTA button",
          desc: "One high-contrast call-to-action button, easy to spot, closing the page",
        },
      ],
    },
    faq: {
