...
// landing-page zone in the generated still: hero headline (~top), testimonial
// proof band (~middle), CTA button (~bottom). Desktop ≥760px only.
const ANATOMY_DOTS = [
  { x: "50%", y: "27%" },
  { x: "50%", y: "55%" },
  { x: "50%", y: "86%" },
  ...
  return (
    <>
      <section className="hero">
        ...
        {/* Full-bleed still — outside .wrap so it spans edge-to-edge (Mission 14). */}
        <Reveal>
        ...
        <div className="wrap">
          <p className="mono hero-photo-caption">{d.home.photoCaption}</p>
              ...
              <Link href={localePath(locale, "/websites")} className="door door-sme">
                <span className="door-still">
                  <img
                    ...
                    loading="lazy"
                  />
                  <span className="door-still-label mono">{d.home.smeLabel}</span>
                </span>
      ...
      {/* Beat 1 — proof strip: commercial first, with photos beside exactly
          those two cards; djnorita.co screenshot (real proof) + ops still only. */}
      ...
      {/* Beat 2 — anatomy: one generated landing-page still with 3 callouts */}
